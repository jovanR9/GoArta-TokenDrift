      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-12 prose prose-lg text-gray-600">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li><strong>Application</strong> refers to GoArta, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GoArta.</li>
            ...
            <li><strong>Website</strong> refers to GoArta, accessible from https://goarta.com</li>
          ...
          <p>If You decide to access or register through or otherwise use a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service&apos;s account, such as Your name, Your email address, Your activities or Your contact list associated with that account.</p>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or any other equivalent form of electronic communication, such as a mobile application&apos;s push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</li>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            <li>By email: privacy@goarta.com</li>
          </ul>
        </div>
