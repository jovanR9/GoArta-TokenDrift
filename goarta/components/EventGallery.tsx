...
export default function EventGallery({ gallery, title }: EventGalleryProps) {
  // Filter out invalid URLs and example.com URLs
  const validGallery = gallery.filter(url => 
    url && 
        ...
        <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
          <Image
            ...
            onError={(e) => {
              ...
              target.src = "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=1600&auto=format&fit=crop";
      ...
      {validGallery.length > 3 && (
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {validGallery.slice(3).map((img, index) => (
              <div
                key={index}
